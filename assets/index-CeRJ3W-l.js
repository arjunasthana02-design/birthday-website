...
`})]})}function se(){let[e,t]=(0,_.useState)(`brownie`);return e===`home`?(0,x.jsx)(C,{goNext:()=>{t(`moods`)},goBack:()=>{t(`brownie`)}}):e===`moods`?(0,x.jsx)(ne,{goBack:()=>{t(`home`)}}):e===`todo`?(0,x.jsx)(te,{goBack:()=>{t(`moods`)}}):(0,x.jsx)(ee,{enterWorld:()=>{t(`home`)}})}v.createRoot(document.getElementById(`root`)).render((0,x.jsx)(_.StrictMode,{children:(0,x.jsx)(se,{})}));