...
`})]})}function ce(){let[e,t]=(0,y.useState)(`brownie`);return(0,x.jsxs)(x.Fragment,{children:[e===`brownie`&&(0,x.jsx)(ee,{next:()=>t(`intro`)}),e===`intro`&&(0,x.jsx)(S,{next:()=>t(`home`)}),e===`home`&&(0,x.jsx)(te,{next:()=>t(`moods`)}),e===`moods`&&(0,x.jsx)(re,{next:()=>t(`todo`)}),e===`todo`&&(0,x.jsx)(ne,{})]})}b.createRoot(document.getElementById(`root`)).render((0,x.jsx)(y.StrictMode,{children:(0,x.jsx)(ce,{})}));